...
window.addEventListener('load', AMVE_pageImportVideos, false);

function AMVE_pageImportVideos() {
        ...
        var importVideos = new Vue({
            ...
            methods: {
                loadPartnerCats: function () {
                    ...
                    this.$http.post(
                            AMVE_import_videos.ajax.url, {
                                action: 'amve_load_partner_cats',
                                nonce: AMVE_import_videos.ajax.nonce,
                                partner_categories: this.selectedPartnerObject.categories,
                ...
                importVideos: function () {
                    ...
                    jQuery('.menu-icon-post .wp-menu-name').append(' <span class="amve-update-posts"><span class="plugin-count"></span></span>');
                    jQuery('[data-id="cat_s_select"]').prop("disabled", true);
                    jQuery('[data-id="partner_select"]').prop("disabled", true);
                ...
                update_1_3_1: function () {
                    this.$http.post(
                        AMVE_import_videos.ajax.url, {
                            action: 'amve_update_1_3_1',
                            nonce: AMVE_import_videos.ajax.nonce
                        }, {
                            emulateJSON: true
                        })
                    .then((response) => {
                        // success callback
                        if(response.body.nb_posts && response.body.nb_posts > 0) {
                            this.updates.show_1_3_1 = true;
                            this.update_1_3_1();
                        } else {
                            this.updates.show_1_3_1 = false;
                        }
                    }, (response) => {
                        // error callback
                        console.error(response);
            ...
            update_1_4_5: function () {
                    this.$http.post(
                        AMVE_import_videos.ajax.url, {
                            action: 'amve_update_1_4_5',
                            nonce: AMVE_import_videos.ajax.nonce
                        }, {
                            emulateJSON: true
                        })
                    .then((response) => {
                        // success callback
                        if(response.body.nb_posts && response.body.nb_posts > 0) {
                            this.updates.show_1_4_5 = true;
                            this.update_1_4_5();
                        } else {
                            this.updates.show_1_4_5 = false;
                        }
                    }, (response) => {
                        // error callback
                        console.error(response);
            ...
            mounted: function () {
                ...
                this.$http.post(
                        AMVE_import_videos.ajax.url, {
                            action: 'amve_load_import_videos_data',
                            nonce: AMVE_import_videos.ajax.nonce
                        }, {
                            emulateJSON: true
                        })
                    .then((response) => {
                        ...
                        this.allPartnersCounter = Object.keys(this.data.partners).length;
            ...
            components: {
                ...
                'partner-options': {
                    ...
                    methods: {
                        saveOptions: function () {
                            ...
                            this.$http.post(
                                    AMVE_import_videos.ajax.url, {
                                        action: 'amve_save_partner_options',
                                        nonce: AMVE_import_videos.ajax.nonce,
                                        partner_id: this.selectedPartnerObject.id,
                ...
                'feed': {
                    ...
                    mounted: function() {
                      if (!this.wpCatExists && this.feed.auto_import ) {
                        this.toggleAutoImport(false);
                      }
                    },
                    template: `
                    ...
                    methods: {
                        changeStatus: function (newValue) {
                            ...
                            this.$http.post(
                                    AMVE_import_videos.ajax.url, {
                                        action: 'amve_change_feed_status',
                                        nonce: AMVE_import_videos.ajax.nonce,
                        ...
                        toggleAutoImport: function (newValue) {
                            ...
                            this.$http.post(
                                    AMVE_import_videos.ajax.url, {
                                        action: 'amve_toggle_feed_auto_import',
                                        nonce: AMVE_import_videos.ajax.nonce,
                                        feed_id: this.feed.id,
                                        new_value: newValue
                                    }, {
