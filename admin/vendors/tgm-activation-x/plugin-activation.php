...
add_action( 'tgmpa_register', 'AMVE_register_required_plugins' );

function AMVE_register_required_plugins() {
	...
	$config = array(
		'id'           => 'AMVE',                   // Unique ID for hashing notices for multiple instances of TGMPA.
